                            ...
                            <ul class="flex flex-col gap-2.5">
                                @foreach ($pkg['features'] as $feature)
                                    <li class="flex items-start gap-2.5 text-sm text-[#888888] font-medium">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-4 h-4 mt-0.5 shrink-0 text-accent-500"><path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5"/></svg>
                                        {{ $feature }}
                                    </li>
                                @endforeach
                            </ul>
    ...
    <div class="solar-container">
        ...
        <div class="reveal" data-variant="fade-up" data-delay="150">
            <form id="palash-application-form" action="{{ route('palash.submit') }}" method="POST" class="max-w-5xl mx-auto bg-secondary rounded-2xl p-6 sm:p-10 shadow-sm">
                ...
                <div id="palash-success" class="hidden bg-accent-500/15 text-forest-500 p-4 rounded-lg text-base font-medium border border-accent-500/40 mb-8 flex items-center gap-2 transition-all">
                ...
                <div id="palash-error" class="hidden bg-red-50 text-red-600 p-4 rounded-lg text-base font-medium border border-red-200 mb-8 flex items-center gap-2 transition-all">
                ...
                <div class="mb-10">
                    ...
                    <div class="mt-6 space-y-6">
                        ...
                        <div class="flex flex-col gap-2 hidden" data-palash-exp>
        ...
        fetch(form.action, {
            ...
            .then(function (json) {
                if (json.success) {
                    ...
                    serviceInputs.forEach(function (el) { el.disabled = false; });
