...
@if ($socialFb)
    <a href="{{ $socialFb }}" target="_blank" rel="noopener noreferrer" class="rounded-xl flex items-center justify-center transition-all" aria-label="Facebook">
...
@endif
@if ($socialX)
    <a href="{{ $socialX }}" target="_blank" rel="noopener noreferrer" class="rounded-xl flex items-center justify-center transition-all" aria-label="X">
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24"><rect width="24" height="24" rx="3" fill="#000000"/><path d="M18.901 1.153h3.68l-8.04 9.19L24 22.847h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.806l5.38 7.12 6.715-7.12zM17.61 20.644h2.039L6.486 3.24H4.298L17.61 20.644z" fill="#ffffff"/></svg>
    </a>
@endif
@if ($socialIg)
    <a href="{{ $socialIg }}" target="_blank" rel="noopener noreferrer" class="rounded-xl flex items-center justify-center transition-all" aria-label="Instagram">
...
@endif
@if ($socialLi)
    <a href="{{ $socialLi }}" target="_blank" rel="noopener noreferrer" class="rounded-xl flex items-center justify-center transition-all" aria-label="LinkedIn">
...
@endif
@if ($socialYt)
    <a href="{{ $socialYt }}" target="_blank" rel="noopener noreferrer" class="rounded-xl flex items-center justify-center transition-all" aria-label="YouTube">
